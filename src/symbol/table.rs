use super::types::{CpuMask, InsnHandler, SizeFlags};
use super::types::{cmask, sz, reg};
...
/// 命令テーブルエントリ
pub(super) struct OpcodeEntry {
    pub(super) name:    &'static str,
    pub(super) handler: InsnHandler,
    pub(super) opcode:  u16,
    pub(super) arch:    CpuMask,
    pub(super) size:    SizeFlags,
    pub(super) size2:   SizeFlags,
    pub(super) noopr:   bool,
}
...
pub(super) static OPCODE_TABLE: &[OpcodeEntry] = &[
    // ---- データ転送 ----
