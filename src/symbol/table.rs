...
pub(super) static REGISTER_TABLE: &[RegEntry] = &[
    ...
    ("msp", 0x3C00, reg::MSP),
    ("isp", 0x3C00, reg::ISP),
    ("cacr", 0x3C07, reg::CACR),
    ("caar", 0x0C00, reg::CAAR),
    // 68060
    ("buscr", 0x2000, reg::BUSCR),
    ("pcr", 0x2000, reg::PCR),
    ...
    ("fp6", 0x3080, reg::FP6),
    ("fp7", 0x3080, reg::FP7),
    ("fpcr", 0x3080, reg::FPCR),
    ("fpsr", 0x3080, reg::FPSR),
    ("fpiar", 0x3080, reg::FPIAR),
    // ColdFire専用
    ("rombar", 0x0007, reg::ROMBAR),
    ("rambar0", 0x0007, reg::RAMBAR0),
    ("rambar1", 0x0007, reg::RAMBAR1),
    ("mbar", 0x0007, reg::MBAR),
    ("acc", 0x0007, reg::ACC),
    ("macsr", 0x0007, reg::MACSR),
...
impl OpcodeEntry {
    ...
    /// オペランドなし命令（NOP/RTS等）
    const fn noop(name: &'static str, handler: InsnHandler, opcode: u16, arch: CpuMask) -> Self {
        OpcodeEntry {
            name,
            handler,
            opcode,
...
const C010_UP: CpuMask = CpuMask(
    crate::options::cpu::C010
        | crate::options::cpu::C020
        | crate::options::cpu::C030
        | crate::options::cpu::C040
        | crate::options::cpu::C060,
);
/// 全68k + CF530/CF540（C520を含まない - divu/divs用）
const M68K_CF53: CpuMask = CpuMask(
    crate::options::cpu::C000
        | crate::options::cpu::C010
        | crate::options::cpu::C020
        | crate::options::cpu::C030
        | crate::options::cpu::C040
        | crate::options::cpu::C060
        | crate::options::cpu::C530
...
pub(super) static OPCODE_TABLE: &[OpcodeEntry] = &[
    ...
    OpcodeEntry::op(
        "move16",
        InsnHandler::Move16Insn,
        0xF600,
        CpuMask(crate::options::cpu::C040 | crate::options::cpu::C060),
        sz::NONE,
        sz::NONE,
    ),
    OpcodeEntry::op(
        "cinvl",
        InsnHandler::CInvPushLP,
        0xF408,
        CpuMask(crate::options::cpu::C040 | crate::options::cpu::C060),
        sz::NONE,
        sz::NONE,
    ...
    OpcodeEntry::op(
        ...
        InsnHandler::FMove,
        0xF200,
        CpuMask(crate::options::cpu::C040 | crate::options::cpu::C060 | crate::options::cpu::CFPP),
